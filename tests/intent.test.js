...
const cases = [
  ...
  ['change to 9 AM', INTENTS.REMINDER_UPDATE],
  ['change to 7 PM', INTENTS.REMINDER_UPDATE],
  ['make it 6 PM', INTENTS.REMINDER_UPDATE],
  ['set reminder to 8 AM', INTENTS.REMINDER_UPDATE],
  ['move reminder to tomorrow evening', INTENTS.REMINDER_UPDATE],
  ['change reminder time', INTENTS.REMINDER_UPDATE],
